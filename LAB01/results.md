...
Transfer Learning Models — comparison of eight pretrained CNN architectures.

Classifiers on Deep Features — comparison of traditional machine learning classifiers using extracted deep features.

Computational Efficiency — comparison of parameter count, model size, FLOPs, inference time, and classification accuracy.
